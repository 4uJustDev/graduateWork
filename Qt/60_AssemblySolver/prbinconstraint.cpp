...
{
    switch ( static_cast<AssmSolverSceneWidget::Commands>(proc->GetCustomKey().GetKey()) )
    {
        case AssmSolverSceneWidget::Coincident: return GCM_COINCIDENT;        
        case AssmSolverSceneWidget::Coaxial:    return GCM_CONCENTRIC;
        case AssmSolverSceneWidget::Parallel:       return GCM_PARALLEL;
        case AssmSolverSceneWidget::Perpendicular:  return GCM_PERPENDICULAR;
        case AssmSolverSceneWidget::Distance:   return GCM_DISTANCE;
        case AssmSolverSceneWidget::Angular:    return GCM_ANGLE;
    }
    return GCM_UNKNOWN;
}
...
// 
// ---
PrBinConstraint::PrBinConstraint(AssmSolverSceneWidget::Commands cmd, 
