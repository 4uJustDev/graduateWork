...
// 
// ---
PrBase::PrBase(AssmSolverSceneWidget* pSceneWidget)
    : VSN::Node()
    , m_bReady(false)
...
public:
    explicit PrFixItem(AssmSolverSceneWidget* pSceneWidget);
    virtual ~PrFixItem();
protected:
...
// 
// ---
PrFixItem::PrFixItem(AssmSolverSceneWidget* pSceneWidget)
    : PrBase(pSceneWidget)
    , m_selectedGeoms()
{
    SetCustomKey(NodeKey(AssmSolverSceneWidget::FixItem));
